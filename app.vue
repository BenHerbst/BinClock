  ...
  <div class="bg-[#0e192e] h-screen">
    <div class="flex flex-col items-center justify-center h-screen">
      ...
      <div class="pt-10 flex flex-col md:flex-row">
        ...
        <a href="https://github.com/BenHerbst/BinClockMobile" type="button" class="text-[#11192e] transition-all active:scale-90 bg-[#57c5ab] font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">Mobile Version</a>
